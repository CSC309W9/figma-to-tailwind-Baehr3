  ...
  return (
    <div className="w-[1769px] h-[1151px] relative bg-gradient-to-b from-[#db4439] to-[#75241e] overflow-hidden">
      <div className="w-[150px] h-[52px] left-[1567px] top-[58px] absolute">
        ...
        <div className="left-[50px] top-[14px] absolute justify-start text-[#db4439] text-base font-black font-['Inknut_Antiqua']">Order</div>
      </div>
      <div className="origin-top-left rotate-[6.64deg] w-[543px] h-[590.40px] left-[1068.69px] top-[226px] absolute">
        <img className="w-[922px] h-[500px] left-[-150px] top-[30px] absolute" src="https://www.myweekly.co.uk/wp-content/uploads/sites/9/2018/06/iStock-814684194-coffee-x.jpg" />
      </div>
